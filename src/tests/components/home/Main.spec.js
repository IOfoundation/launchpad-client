...
describe('<HomePage />', () => {
  ...
  it('Should macth the remarks, title and subtitle', () => {
    ...
    expect(wrapper.find('.main-title').text()).toEqual('Where startups and small business connect inCalifornia\'s Capital Region');
    expect(wrapper.find('.mobile-devices').text()).toEqual('Where startups and small business connect in California\'s Capital Region');
  });
});
